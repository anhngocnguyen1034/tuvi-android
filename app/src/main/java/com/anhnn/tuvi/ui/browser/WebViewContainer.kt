...
import com.anhnn.tuvi.presentation.BrowserCommand
    ...
    val host = remember {
        ...
        val srl = SwipeRefreshLayout(context).apply {
            ...
            setColorSchemeColors(
                com.anhnn.tuvi.ui.theme.TuViGold.value.toInt(),
                com.anhnn.tuvi.ui.theme.TuViGoldDark.value.toInt()
            )
        ...
        wv.webViewClient = object : WebViewClient() {
            ...
            override fun onReceivedError(
                ...
                if (request?.isForMainFrame == true) {
                    srl.isRefreshing = false
                    onError(error?.description?.toString() ?: resources.getString(com.anhnn.tuvi.R.string.browser_error_unknown))
                }
            }
        }
